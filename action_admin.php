...
if(empty($_POST["email"]) || empty($_POST["pass"]))
	...
	if($_SESSION['name']!=false && $_SESSION['email']!=false)
	{
	   	...
	   	echo '<a href="#"><button type="button" class="btn btn-primary btn-lg adminButton">Change password</button></a><br>';
	   	echo '<a href="#"><button type="button" class="btn btn-warning btn-lg adminButton">Edit old info</button></a><br>';
	   	echo '<a href="addInfo.php"><button type="button" class="btn btn-info btn-lg adminButton">Add new info</button></a><br>';
	   	echo '<a href="#"><button type="button" class="btn btn-danger btn-lg adminButton">Delete info</button></a><br>';
